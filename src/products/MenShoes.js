...
const MenShoes = ({ data ,addToCart }) => {
    ...
    return (
        <div className="">
            <Nav/>
            <Wrapper > 
            <h3 className="m-0 pl-5 pb-10 text-xl xl:text-2xl font-semibold">Men's Sneakers + Shoes ({menData.length})</h3>
