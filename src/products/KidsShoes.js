...
const KidsShoes = ({ data ,addToCart }) => {
    ...
    return (
        <div className="">
            <Nav/>
            <Wrapper > 
            <h3 className="m-0 pl-5 pb-10 text-xl xl:text-2xl font-semibold">Kid's Sneakers + Shoes ({kidsData.length})</h3>
